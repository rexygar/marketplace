              ...
              <div class="w-full max-w-6xl rounded md:mb-0  ">
                <div class="relative panel-wrapper">
                  <div class=" ">
                    ...
                    font-size: 14px;" class="font-bold  text-base text-center overflow-auto">Tecnobuy</h5>
                    <p class="text-sm font-bold text-center text-black ">$ 999.999</p>
                    ...
                    <h6 class=" UPPERCASE text-center" style="font-weight: 100">8801643388997</h6>
