  ...
  <main class="h-full flex items-center px-6 lg:px-32   relative" style="background-color: #2F4858">
    <header class="w-full absolute left-0 top-0 p-6 lg:p-32 md:visible lg:visible invisible">
      <div class="flex justify-between">
        <div>
          <h1 class="  font-bold"> <img class="branding__logo img-fluid"
              src="{{ asset('img/logo_ok.png') }}" width="95" alt=""></h1>

        </div>
      </div>
    </header>
    {{-- div  --}}
    <div class="grid grid-cols-12 md:grid-cols-4 lg:grid-cols-4 gap-4">
      <div class="lg:w-full md:col-span-2 lg:col-span-2 col-span-6  md:w-full">
        <h2 class="flex justify-center text-xl lg:text-7xl md:text-2xl  pb-4 font-bold text-green-50 border-gray-200">
          <span class="pt-4 font-bold uppercase tracking-widest bg-yellow-300 px-6">TRADE IN</span>
        </h2>
        <figure class="image flex justify-center  md:visible lg:visible invisible pb-6 mx-auto md:w-2/5 md:h-1/5 lg:h-1 lg:w-1/5" style="z-index: 99">
        ...
        <h5 class="flex justify-center relative md:pb-0 lg:-mb-10  font-bold text-green-50 border-gray-200">
          <span class="lg:text-xl md:text-sm text-sm mt-6 lg:py-10 mr-1">RECAMBIA TU ANTIGUO EQUIPO ENTREGANDO TU ANTIGUO
            SMARTPHONE</span>
        </h5>

        <h6 class="flex justify-center font-extralight text-green-50 border-gray-200">
          <span class="lg:text-base mt-6 md:mt-2 text-sm md:text-sm mr-1">Aceptamos tu Smartphone o tablet de cualquier
            marca
            como
      ...
      <div class="lg:w-full md:col-span-2 lg:col-span-2 col-span-6 md:w-full overflow-hidden pr-10">
