<div class="col-span-12 grid grid-cols-7 _Diseño py-20 px-36 md:px-16 lg:px-36 2xl:px-36 xl:px-36">
            ...
            <div class="relative panel-wrapper">
              <div
                ...
                <div
                  ...
                  <p class="text-white text-center font-bold text-5xl md:text-2xl lg:text-5xl xl:text-5xl 2xl:text-5xl mix-blend-multiply pt-24 md:pt-12 lg:pt-24 xl:pt-24 2xl:pt-24 uppercase">Diseño</p>
