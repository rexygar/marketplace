<div class="col-span-12 grid grid-cols-7 _Salud py-20 px-36  sm:px-10  md:px-16 lg:px-24 2xl:px-36 xl:px-36 ">
  <div
    ...
    <?php
    $img_producto = null;
    $img_tienda = $tiendas_s->logo;

    if ( $tiendas_s->producto != null) {

    foreach ($tiendas_s->producto as $p) {
    if ($loop->first) {
    $img_producto = $p->img;
