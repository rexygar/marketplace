<div class="col-span-12 grid grid-cols-7 _Textil py-20 px-6 sm:px-10  md:px-16 lg:px-36 2xl:px-36 xl:px-36">
  <div
    class="col-span-7 grid md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 grid-cols-2 sm:gap-0  gap-6 lg:gap-4">
