<div
  class="col-span-12 grid grid-cols-7 _Textil py-20 px-2   sm:px-10  md:px-16 lg:px-24 2xl:px-36 xl:px-36 animate__fadeInUp animate__animated wow">
  <div
          ...
          <div class="w-full max-w-6xl rounded md:mb-0  ">
            <div class="relative panel-wrapper">
              <div data-background-image="{{$ruta_t }}{{$img_t }}"
                ...
                <div
                  class="  h-full  w-full absolute  bg-blend-darken left-0 top-0 opacity-75 hover:opacity-95 rounded-3xlhover:bg-transparent hover:border-black"
                  style=" display: table;">
