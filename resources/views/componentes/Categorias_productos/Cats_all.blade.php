<div class="col-span-12 grid grid-cols-7  py-20 px-36 sm:px-10  md:px-16 lg:px-36 2xl:px-36 xl:px-36">
          ...
          <div class="w-full max-w-6xl rounded md:mb-0  ">
            <div class="relative panel-wrapper">
              <div
                ...
                <div
                  class="px-6 py-4 h-full  w-full absolute  bg-blend-darken left-0 top-0 opacity-50 hover:opacity-75 bg-blue-500 hover:bg-yellow-500">
                  <p
