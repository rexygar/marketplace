<div class="col-span-12 grid grid-cols-7 _Diseño py-20 px-36 sm:px-10 md:px-16 lg:px-36 2xl:px-36 xl:px-36">
            ...
            <div class="relative panel-wrapper">
              <div
                ...
                <div
                  ...
                  <p
                    class="text-white sm:pt-0 sm:text-2xl text-center sm:pt-0 sm:text-2xl font-bold text-5xl md:text-2xl lg:text-5xl xl:text-5xl 2xl:text-5xl mix-blend-multiply pt-24 md:pt-12 lg:pt-24 xl:pt-24 2xl:pt-24 uppercase">
                    Diseño</p>
            ...
            <div class="relative panel-wrapper">
              <div
                ...
                <div
                  class="px-6 py-4 h-full  w-full absolute  bg-blend-darken left-0 top-0 opacity-50 bg-blue-500 hover:bg-yellow-500">
                  <p
                    class="text-white text-center font-bold text-5xl md:text-2xl lg:text-5xl xl:text-5xl 2xl:text-5xl mix-blend-multiply pt-24 md:pt-12 lg:pt-24 xl:pt-24 2xl:pt-24 uppercase">
                    Diseño</p>
