...
<div
  class="col-span-12 grid grid-cols-12 h-full md:px-6 lg:px-16 xl:px-16 2xl:px-16 pt-6  md:pt-6  lg:pt-6  xl:pt-6  2xl:pt-6  ">
  ...
  <div class="col-span-12 grid gap-4 grid-cols-12 py-4 xs:px-6 sm:px-16 md:px-16 lg:px-16 2xl:px-16 xl:px-16 ">
    ...
    <img class="col-span-12 " src="{{ asset('img/QUIENES SOMOS_/BANNER-INICIAL.png') }}" alt="">
