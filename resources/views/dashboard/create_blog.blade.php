            ...
            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              <div class="flex flex-col">
                <form action="{{ route('add.blog') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <span class="text-xl leading-relaxed text-center sm:text-left  w-full font-bold text-gray-700">Titulo
                    de la publicación</span>
                  <input type="text"
                    ...
                    name="titulo" value="@if (isset($blog->titulo)){{ $blog->titulo }} @endif">
                  <div class="mt-8">
