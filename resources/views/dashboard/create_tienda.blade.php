            ...
            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              <div class="flex flex-col">
                <form action="{{ route('update.tienda') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <span class="text-xl leading-relaxed text-center sm:text-left  w-full font-bold text-gray-700">Nombre
                    de la Tienda</span>
                  <input type="text"
                    ...
                    name="nombre" value="{{ $tienda->razon_social }}">
                  <div class="mt-8">

                  </div>
                  <span
                    class="text-xl leading-relaxed text-center sm:text-left  w-full font-bold text-gray-700">Descripción
                    de la Tienda</span>
                  <input type="text"
                    class="text-sm pl-4 w-full inline-block  text-justify align-middle  rounded-2xl md:p-2 bg-white border-2 border-gray-300  placeholder-gray-600 shadow-md focus:placeholder-gray-500  focus:border-gray-600 focus:outline-none"
                  ...
                  <span class="text-xl leading-relaxed text-center sm:text-left  w-full font-bold text-gray-700">Foto de
                    la Tienda</span>
                  ...
                  <span
                    class="text-xl leading-relaxed text-center sm:text-left  w-full font-bold text-gray-700">Instagram
                    de la Tienda</span>
                  <input type="text"
                    class="text-sm pl-4 w-full inline-block  text-justify align-middle  rounded-2xl md:p-2 bg-white border-2 border-gray-300  placeholder-gray-600 shadow-md focus:placeholder-gray-500  focus:border-gray-600 focus:outline-none"
                    name="instagram" value="@if (isset($tienda->instagram)){{ $tienda->instagram }} @endif">
                  <div class="mt-8">

                  </div>
                  <span
                    class="text-xl leading-relaxed text-center sm:text-left  w-full font-bold text-gray-700">Facebook de
                    la Tienda</span>
                  <input type="text"
                    class="text-sm pl-4 w-full inline-block  text-justify align-middle  rounded-2xl md:p-2 bg-white border-2 border-gray-300  placeholder-gray-600 shadow-md focus:placeholder-gray-500  focus:border-gray-600 focus:outline-none"
                    name="facebook" value="@if (isset($tienda->facebook)){{ $tienda->facebook }} @endif">
                  <div class="pt-4 flex items-center space-x-4">
                    <button id="crear" type="submit"
                      class="bg-blue-500 flex justify-center items-center w-full text-white px-4 py-3 rounded-md focus:outline-none">Editar</button>
